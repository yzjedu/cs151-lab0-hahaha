...
# Credits: Code based on class assignment


print ("CS151 Lab 0") #The code outputs "CS151 Lab 0"

print("My partner is Andrew Leimbach.") #code prints the name of my partner
...
print("My partner is Harry Li.") #code prints the name of my partner

#codes outputs 5 different facts about my partner
print("He is from Baltimore County, Maryland.")
print("He is a Computer Science Major.")
print("He lives in Thea Bowman Hall.")
print("He plays badminton and tennis.")
print("He has traveled to China three times.")
